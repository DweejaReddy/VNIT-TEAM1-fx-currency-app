...
async function chartItP(currId1, currId2, year, month, day, duration, xlabel, sf) {
...
function chartChange() {
    ...
    if(check) {
      ...
      switch(type){
        case "1M":
          chartItP(currId1, currId2, year, month, day, 30, "day", "DD");
        break;

        case "1Q":
          chartItP(currId1, currId2, year, month, day, 91, "month", "MMM");
        break;

        case "2Q":
          chartItP(currId1, currId2, year, month, day, 92, "month", "MMM");
        break;

        case "3Q":
          chartItP(currId1, currId2, year, month, day, 93, "month", "MMM");
        break;

        case "4Q":
          chartItP(currId1, currId2, year, month, day, 94, "month", "MMM");
        break;

        case "weekly":
          chartItP(currId1, currId2, year, month, day, 7, "month", "MMM");
        break;

        case "quarterly":
          chartItP(currId1, currId2, year, month, day, 95, "month", "MMM");
        break;

        case "monthly":
          chartItP(currId1, currId2, year, month, day, 12, "month", "MMM");
        break;

        case "yearly":
          chartItP(currId1, currId2, year, month, day, 360, "month", "MMM");
        break;
      }
    }
    })
